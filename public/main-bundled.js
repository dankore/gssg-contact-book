!(function (e) {
  ...
  function (e, t, n) {
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: 'isDifferent',
            value: function (e, t) {
              e.previousValue != e.value && t.call(this), (e.previousValue = e.value);
            },
          },
          {
              ...
              value: function () {
                ...
                this.likesButton.classList.contains('yes-toggle')
                  ? ((t = -1),
                    ...
                    Array.prototype.forEach.call(this.likesButtonSVG, function (e) {
                      e.classList.remove('yes'), e.classList.add('no'), (e.style.fill = 'white');
                    }))
                  : ((t = 1),
                    (n = 'yes'),
                    ...
                    Array.prototype.forEach.call(this.likesButtonSVG, function (e) {
                      e.classList.add('yes'), e.classList.remove('no'), (e.style.fill = '#16A34A');
                    })),
                  w
                    .post('/likes', { like: t, color: n })
                    .then(function (t) {
                      w.post('/get-visited-profile-doc')
                        .then(function (t) {
                          ...
                          n.length < 1 ? (e.likesContainer.innerHTML = '') : 1 == n.length ? (e.likesContainer.innerHTML = 'Liked by '.concat(n[0])) : 2 == n.length ? (e.likesContainer.innerHTML = 'Liked by '.concat(n.slice(0, 1), ' & ').concat(n.slice(1).length, ' other')) : (e.likesContainer.innerHTML = 'Liked by '.concat(n.slice(0, 1), ' & ').concat(n.slice(1).length, ' others'));
                        })
                        .catch(function (e) {
                          console.log(e);
                        });
          ...
          (n = [
            {
              ...
              value: function () {
                ...
                this.likesContainer.addEventListener('click', function (t) {
                  ...
                  this.likesContainer.addEventListener('mouseover', function (t) {
                    return e.handleButtonClick(t);
                  }),
            ...
            },
            {
              ...
              value: function () {
                this.namesContainerUL && (this.namesContainerUL.style.display = 'none');
              },
            },
            {
              key: 'handleButtonClick',
              value: function (e) {
                var t = this;
                e.stopPropagation(),
                  C.post('/get-visited-profile-doc')
                    .then(function (e) {
                      for (var n = [], r = 0; r < e.data.length; r++) 'yes' == e.data[r].color && n.push(e.data[r].visitorName);
    ...
    T.prototype.li = function (e) {
      ...
      o.setAttribute('href', '/contacts/'.concat(e.visitorEmail));
      var i = document.createElement('img');
      i.setAttribute('src', ''.concat(e.photo)), i.classList.add('w-8', 'h-8', 'rounded-full'), i.setAttribute('alt', 'profile pic');
      var a = document.createElement('div');
      a.classList.add('rounded', 'px-2'), a.setAttribute('style', 'overflow-wrap:break-word;min-width:0px;width:15rem;background-color:#F2F3F5;');
      var s = document.createElement('a');
      s.setAttribute('href', '/contacts/'.concat(e.visitorEmail)), s.classList.add('font-medium'), (s.innerText = ''.concat(e.visitorFirstName));
      var l = document.createElement('p');
      l.innerText = ''.concat(e.comment);
      var c = document.createElement('div');
      c.classList.add('flex', 'justify-between', 'items-center', 'mt-2', 'text-xs');
      var u = document.createElement('p');
      u.innerText = ''.concat(e.commentDate);
      var d = document.createElement('div');
      d.classList.add('flex');
      var f = document.createElement('input');
      f.setAttribute('type', 'button'), f.setAttribute('value', 'Edit'), (f.id = 'edit-comment-button'), f.classList.add('flex', 'bg-white', 'items-center', 'cursor-pointer');
      var m = document.createElement('input');
      m.setAttribute('type', 'button'), m.setAttribute('value', 'Delete'), m.setAttribute('data-id', ''.concat(e.commentId)), (m.id = 'delete-comment-button'), m.classList.add('flex', 'ml-3', 'bg-white', 'text-red-600', 'items-center', 'cursor-pointer');
      var h = document.createElement('div');
      (h.id = 'edit-comment-container'), h.classList.add('modal'), (h.style.display = 'none');
      var p = document.createElement('textarea');
      (p.id = 'input-comment'), (p.innerText = ''.concat(e.comment)), p.setAttribute('data-id', ''.concat(e.commentId)), p.setAttribute('style', 'background-color: #F2F3F5; white-space:pre-wrap; overflow: hidden;'), p.classList.add('w-full', 'p-2', 'border', 'border-green-400', 'rounded');
      var y = document.createElement('div');
      y.classList.add('flex', 'justify-between', 'py-4');
      var v = document.createElement('button');
      (v.id = 'cancel-comment-button'), v.classList.add('bg-green-600', 'text-white', 'px-2', 'rounded', 'hover:bg-green-800');
      var g = document.createTextNode('Cancel');
      v.appendChild(g);
      var b = document.createElement('button');
      (b.id = 'update-comment-button'), b.setAttribute('data-id', ''.concat(e.commentId)), b.classList.add('bg-green-600', 'text-white', 'px-2', 'rounded', 'hover:bg-green-800');
      var w = document.createTextNode('Update');
      return b.appendChild(w), o.appendChild(i), r.appendChild(o), a.appendChild(s), a.appendChild(l), n.appendChild(r), n.appendChild(a), c.appendChild(u), d.appendChild(f), d.appendChild(m), c.appendChild(d), y.appendChild(v), y.appendChild(b), h.appendChild(p), h.appendChild(y), t.appendChild(n), t.appendChild(c), t.appendChild(h), t;
    };
    var A = n(1),
      O = (function () {
        function e() {
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (e) {
                (e.target.style.height = '1px'), (e.target.style.height = 25 + e.target.scrollHeight + 'px'), (this.input.style.height = '1px'), (this.input.style.height = 25 + this.input.scrollHeight + 'px');
              },
            },
            {
              key: 'handleCancelEditCommentConatiner',
              value: function (e) {
                var t = e.target.parentElement.parentElement.parentElement.children[2];
            ...
            },
            {
              ...
              value: function (e) {
                var t = e.target.parentElement.parentElement.parentElement.children[2],
                  n = t.children[0];
                'none' == t.style.display ? ((t.style.display = 'block'), this.modalOverlay.classList.add('active'), t.classList.add('active'), n.focus()) : (t.style.display = 'none');
              },
            },
            {
              ...
              value: function (e) {
                var t = e.target.parentElement.parentElement.parentElement.children[2],
                  n = t.children[0],
                  r = e.target.parentElement.parentElement.parentElement.children[1].children[0],
                  o = e.target.parentElement.parentElement.parentElement.children[0].children[1].children[1];
                n.value &&
                  (A.post('/edit-comment', { commentId: n.getAttribute('data-id'), comment: n.value })
                    .then(function (e) {
                      (o.innerText = e.data.comment), (r.innerText = e.data.commentDate);
                    })
                    .catch(function (e) {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                confirm('Are you sure?') &&
                  A.post('/delete-comment', { commentId: e.target.getAttribute('data-id') })
                    .then(function (n) {
                      t.handleCommentCountAndCommentGrammar(-1), e.target.parentElement.parentElement.parentElement.remove();
                    })
                    .catch(function (e) {
                      console.log(e);
                    });
            ...
            },
            {
              ...
              value: function (e) {
                1 == e ? (this.commentsCount.innerText = +this.commentsCount.innerText + 1) : 1 == this.commentsCount.innerText ? (this.commentsCount.innerText = '') : (this.commentsCount.innerText = +this.commentsCount.innerText - 1);
                var t = this.commentsCount.innerText;
                this.commentWordContainer.innerText = 0 == t ? '' : 1 == t ? 'comment' : 'comments';
              },
            },
            {
              ...
              value: function () {
                var e = this;
                this.input.value &&
                  A.post('/get-comments', { comment: this.input.value })
                    .then(function (t) {
                      e.handleCommentCountAndCommentGrammar(1), t.data.photo ? t.data.photo : (t.data.photo = 'https://gss-gwarinpa.s3.us-east-2.amazonaws.com/blank.png'), e.commentsContainerUl.insertAdjacentElement('afterbegin', new T().li(t.data)), (e.input.value = ''), e.input.focus();
                    })
                    .catch(function (e) {
                      console.log(e);
                    });
